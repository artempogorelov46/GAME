...
namespace Game
{
    internal class Dialogues
    {
        ...
        public void Chapter2()
        {
            ...
            Console.ReadLine();
            Console.WriteLine("Каждый из врагов сильнее другого, и у каждого свой уровень.");
            Console.ReadLine();
            Console.WriteLine("У тебя есть и свой уровень, ты можешь чувствовать его и чужие. Такова сила нашего клана, служащего королю");
            Console.ReadLine();
            Console.WriteLine("Пока он у тебя маленький, как и твой мозг. Поэтому начинай с Морозного Хребта.");
            Console.ReadLine();
        ...
        public void Chapter3()
        {
            ...
            Console.ReadLine();
            Console.WriteLine("Тебе предстоит сразиться с Харальдом Молнией, звать его так, потому что бьем мечом быстрее молнии");
            Console.ReadLine();
            ...
            Console.ReadLine();
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("Обычный удар нанесёт + 100 урона ");
            Console.WriteLine("Удар плашмя + 150 урона ");
            Console.WriteLine("Выпад + 200 урона ");
            Console.WriteLine("Блок заблокирует половину урона врага");
            Console.ReadLine();
            Console.ForegroundColor = ConsoleColor.Magenta;
            Console.WriteLine("Но это всё, если ты попадёшь, поэтому надо запоминать удары врага и понимать какой удар нанести");
            Console.ReadLine();
            Console.WriteLine("Шанс попадания у обычного удара выше, чем у остальных, а блок ты почти всегда успеешь поставить");
            Console.ReadLine();
